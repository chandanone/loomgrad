                ...
                <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-8 shadow-sm">
                    <form onSubmit={handleImport} className="space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-xl flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-blue-600/20"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className="mt-12 space-y-4">
                        <h3 className="text-sm font-semibold text-zinc-400 uppercase tracking-widest">How it works</h3>
                        <ul className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <li className="bg-white p-4 rounded-lg border border-zinc-200">
                                <span className="block text-blue-600 font-bold mb-1">01</span>
                                <p className="text-xs text-zinc-500">Fetches metadata and all video items from your playlist.</p>
                            </li>
                            <li className="bg-white p-4 rounded-lg border border-zinc-200">
                                <span className="block text-purple-600 font-bold mb-1">02</span>
                                <p className="text-xs text-zinc-500">Auto-generates modules and maps videos to lessons.</p>
                            </li>
                            <li className="bg-white p-4 rounded-lg border border-zinc-200">
                                <span className="block text-green-600 font-bold mb-1">03</span>
                                <p className="text-xs text-zinc-500">Sets the first lesson to free & blurs others for students.</p>
                            </li>
                        </ul>
                    </div>
                </div>
