                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="classLevel" className="w-full border border-zinc-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <select name="subCategory" className="w-full border border-zinc-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">None</option>
                    ...
                    <div>
                        ...
                        <textarea name="helpText" rows={2} placeholder="Quick tips..." className="w-full border border-zinc-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono resize-none" />
                    </div>

                    <div>
                        <label className="block text-sm font-bold text-zinc-700 mb-2">Full Instructions (Category Instruction Page)</label>
                        <textarea name="fullInstruction" rows={5} placeholder="### Instructions for this set...&#10;- You have 30 minutes&#10;- Don't use external libraries..." className="w-full border border-zinc-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono resize-none" />
                    </div>

                    <div>
                        <label className="block text-sm font-bold text-zinc-700 mb-2">Assessment Mode</label>
                        <select name="assessmentMode" className="w-full border border-zinc-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
