            ...
            <div className="max-w-7xl mx-auto">
                <header className="mb-16">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-blue-600 font-bold tracking-widest text-xs uppercase">Interactive Labs</h2>
                    </div>
                ...
                {challenges.length === 0 ? (
                    <div className="bg-zinc-50 border border-zinc-200 rounded-3xl p-20 text-center">
                        <Trophy className="w-16 h-16 text-zinc-300 mx-auto mb-6" />
                        ...
                        {challenges.map((challenge) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="group flex flex-col md:flex-row items-center justify-between gap-6 p-8 bg-zinc-50 border border-zinc-100 rounded-3xl hover:border-blue-500/30 transition-all hover:bg-white hover:shadow-xl hover:shadow-zinc-200/50"
                                >
                                    <div className="flex-grow">
                                        <div className="flex items-center gap-3 mb-3">
                                            <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 px-2 py-0.5 rounded-full border border-zinc-200 bg-white">
                                                {challenge.module.course.title}
                                            </span>
                                            <span className="text-[10px] font-bold uppercase tracking-widest text-blue-600 px-2 py-0.5 rounded-full bg-blue-500/10">
                                    ...
                                    <div className="flex items-center gap-8 min-w-fit">
                                        ...
                                        <div className="w-12 h-12 rounded-2xl bg-white border border-zinc-200 flex items-center justify-center group-hover:bg-blue-600 group-hover:border-blue-500 group-hover:text-white transition-all text-zinc-400 shadow-sm group-hover:shadow-blue-500/20">
