...
export default async function CoursesPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white pt-32 pb-20 px-8 transition-colors duration-300">
            <div className="max-w-7xl mx-auto">
                <header className="mb-12">
                    <h1 className="text-5xl font-bold tracking-tight mb-4">Course Catalog</h1>
                    <p className="text-zinc-600 dark:text-zinc-400 text-lg">Master the most in-demand technical skills with our curated curriculum.</p>
                </header>

                {courses.length === 0 ? (
                    <div className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-12 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {coursesWithLessonCount.map((course) => (
                            <Link
                                ...
                                className="group relative bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all hover:shadow-2xl hover:shadow-blue-500/10"
                            >
                                {/* Thumbnail Container */}
                                <div className="relative aspect-video">
                                    {course.thumbnail ? (
                                        ...
                                        <div className="w-full h-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center">
                                            <Play className="w-12 h-12 text-zinc-400 dark:text-zinc-700" />
                                        </div>
                                    )}
                                    <div className="absolute inset-0 bg-gradient-to-t from-zinc-100 dark:from-zinc-900 via-transparent to-transparent opacity-60" />
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center justify-between text-[13px] text-zinc-500 font-medium border-t border-zinc-200 dark:border-zinc-800 pt-4">
