...
function SignUpPageContent() {
    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center py-6 px-4 md:py-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-50/50 via-white to-white">
            <div className="w-full max-w-md">
                <div className="bg-white border border-zinc-200 p-5 sm:p-7 rounded-[2rem] shadow-2xl transition-all duration-700 animate-in fade-in slide-in-from-bottom-8">
                    <div className="text-center mb-6 mt-2 md:mt-4">
                        ...
                        <p className="text-zinc-500 text-sm">Join the elite community of developers.</p>
                    </div>
                    <div className="grid grid-cols-1 gap-4">
                        <button
                            onClick={() => signIn("google")}
                            className="bg-zinc-50 border border-zinc-200 text-zinc-900 font-medium py-2.5 rounded-2xl hover:bg-zinc-100 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5 md:space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-[9px] text-zinc-400 ml-1">Minimum 8 characters with at least one number.</p>
                        </div>

                        <button
                            disabled={isLoading}
                            type="submit"
                            className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-2xl hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group shadow-lg shadow-blue-600/20 active:scale-[0.98] disabled:opacity-50"
                        >
                            {isLoading ? (
                    ...
                    <p className="mt-5 text-center text-[10px] text-zinc-400 leading-relaxed px-4">
